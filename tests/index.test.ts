...
describe(" blogs testing", () => {
  ...
  it("should  create a blog and return success ", async () => {
    const newBlog= {title:"heloo the guys hii",
...
BlogId = res.body?._id;
   ...
   it("should update blog and return success ", async () => {
     ...
     const res = await request(app).put(`/update-blog/${BlogId}`).send(updateBlog);
     expect(res.status).toEqual(200);
   });
...
describe(" user api testing", () => {
  ...
  it("should  create a register a user  and return success ", async () => {
    const aUser= {email:"emma4@gmail.com",
password:"todayis"
    }
    ...
    const registeredUser= {email:"emma4@gmail.com",
password:"todayis"
    }
